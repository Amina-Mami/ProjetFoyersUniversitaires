...
public class BlocController {
    ...
    @Operation(description = "Récupérer les blocs par foyer", summary = "Get Blocs by Foyer ID", operationId = "7")
    @GetMapping("getByFoyer/{idFoyer}")
    public List<Bloc> getByFoyer(@PathVariable("idFoyer") long idFoyer) {
